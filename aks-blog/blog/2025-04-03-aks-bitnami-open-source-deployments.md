...
authors: [bob-mital]
date: 2025-04-03
description: "Accelerate your Kubernetes deployments on Azure with Bitnami\u2019s\
  \ secure, pre-configured OSS solutions. This guide shows how to use Terraform, Azure\
  \ CLI, and ARM templates to effortlessly deploy popular OSS offers like Argo CD,\
  \ ClickHouse, MinIO, Prometheus Operator, RabbitMQ, Kafka, MongoDB, NGINX, PostgreSQL,\
  \ and Redis\u2014cutting operational overhead and fueling innovation"
tags:
- general
