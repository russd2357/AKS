...
![Screenshot of the inner dev loop](/img/blog/mirrord-dev-loop.png)
...
![Screenshot of the AKS pet store demo app](/img/blog/aks-pet-store.png)
...
![Screenshot of the mirrord extension in vs code](/img/blog/mirrord-vscode-extension.png)

![Screenshot of the mirrord extension in the vs code toolbar](/img/blog/mirrord-vscode-toolbar.png)
...
![Screenshot of the mirrord logs](/img/blog/mirrord-logs.png)
...
![Screenshot of the updated pet store](/img/blog/aks-pet-store-updated.png)
...
![Screenshot of the pet store admin page](/img/blog/aks-pet-store-admin-page.png)
...
![Screenshot of the pet store orders](/img/blog/aks-pet-store-orders.png)
...
![Screenshot of the pet store admin orders](/img/blog/aks-pet-store-admin-orders.png)
